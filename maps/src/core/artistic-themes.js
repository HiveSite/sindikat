export const artisticThemes = {
	studio_paper: {
		name: "Studio Paper",
		description: "Topla papirna mapa sa jasnom hijerarhijom puteva",
		bg: "#EBE6DE", text: "#181818", water: "#DFD9D1", parks: "#E4DED6",
		terrain: "#E8E1D9", building: "#CDC6BE", boundary: "#D7D0C7", rail: "#8F8881",
		road_motorway: "#232120", road_primary: "#615C58", road_secondary: "#9D968F",
		road_tertiary: "#B0A9A1", road_residential: "#C2BBB3", road_default: "#C2BBB3", route: "#F36A2E"
	},
	studio_ink: {
		name: "Japanese Ink",
		description: "Minimalna crno-bijela mapa inspirisana tušem",
		bg: "#F0EDE7", text: "#111111", water: "#E7E2DA", parks: "#EBE7DF",
		terrain: "#EFEAE3", building: "#C2BBB2", boundary: "#D8D2CA", rail: "#7F7974",
		road_motorway: "#1D1B1A", road_primary: "#56514D", road_secondary: "#989189",
		road_tertiary: "#AAA39B", road_residential: "#BDB6AE", road_default: "#BDB6AE", route: "#F36A2E"
	},
	studio_sand: {
		name: "Warm Sand",
		description: "Topli zemljani tonovi za elegantan poster",
		bg: "#EFE3D3", text: "#261D14", water: "#E7D4BF", parks: "#E6D8C8",
		terrain: "#EFDFCB", building: "#D1B99B", boundary: "#D4C3AD", rail: "#947B63",
		road_motorway: "#372519", road_primary: "#6D503A", road_secondary: "#A17F63",
		road_tertiary: "#B89576", road_residential: "#CFB79F", road_default: "#CFB79F", route: "#F36A2E"
	},
	studio_blueprint: {
		name: "Studio Blueprint",
		description: "Arhitektonska plava paleta sa tehničkim karakterom",
		bg: "#E8EEF4", text: "#102131", water: "#D6E4EF", parks: "#DFE8EF",
		terrain: "#EDF3F8", building: "#B8C7D6", boundary: "#CAD7E2", rail: "#758A9F",
		road_motorway: "#15283A", road_primary: "#39516A", road_secondary: "#7A90A5",
		road_tertiary: "#9AADBE", road_residential: "#BCCBDA", road_default: "#BCCBDA", route: "#F36A2E"
	},
	studio_noir: {
		name: "Studio Noir",
		description: "Premium tamna mapa sa bijelim glavnim putevima",
		bg: "#121416", text: "#F4F4F4", water: "#171B1F", parks: "#1A1F23",
		terrain: "#1C2024", building: "#4C5157", boundary: "#2B3036", rail: "#8F969E",
		road_motorway: "#FFFFFF", road_primary: "#D2D7DC", road_secondary: "#98A0A8",
		road_tertiary: "#858C93", road_residential: "#70767D", road_default: "#70767D", route: "#F36A2E"
	},
	studio_forest: {
		name: "Forest Mist",
		description: "Prigušena zelena mapa sa prirodnim osjećajem",
		bg: "#E8EDE7", text: "#1F271D", water: "#DBE6DC", parks: "#DBE8D9",
		terrain: "#E6EDE3", building: "#B8C4B2", boundary: "#CCD7CA", rail: "#7D8878",
		road_motorway: "#283026", road_primary: "#5F6B59", road_secondary: "#879381",
		road_tertiary: "#A1AA9D", road_residential: "#C0CABD", road_default: "#C0CABD", route: "#F36A2E"
	},
	studio_blush: {
		name: "Blush Stone",
		description: "Nježna kamena paleta sa toplim ružičastim tonovima",
		bg: "#F1E7E4", text: "#2B201D", water: "#EAD9D5", parks: "#EFE0DD",
		terrain: "#F3E8E6", building: "#D6BBB4", boundary: "#DBC8C4", rail: "#9A7D76",
		road_motorway: "#3B2824", road_primary: "#7A5A53", road_secondary: "#9E7E77",
		road_tertiary: "#B99A93", road_residential: "#D8C1BC", road_default: "#D8C1BC", route: "#F36A2E"
	},
	studio_slate: {
		name: "Slate Mono",
		description: "Hladna monohromatska mapa za savremen enterijer",
		bg: "#DFE2E6", text: "#1E242B", water: "#D2D9E1", parks: "#D8DEE4",
		terrain: "#E6EAEE", building: "#AEB5BD", boundary: "#C7CED6", rail: "#808992",
		road_motorway: "#262C33", road_primary: "#58606A", road_secondary: "#7B8590",
		road_tertiary: "#9AA3AC", road_residential: "#BCC3CB", road_default: "#BCC3CB", route: "#F36A2E"
	},
	studio_terracotta: {
		name: "Terracotta",
		description: "Topla keramička paleta sa snažnim kontrastom",
		bg: "#F0DED4", text: "#2E1C13", water: "#E8CFC0", parks: "#ECD9CE",
		terrain: "#F3E4DB", building: "#D9AD92", boundary: "#DDC0AF", rail: "#A07359",
		road_motorway: "#43271A", road_primary: "#8F583D", road_secondary: "#AB775D",
		road_tertiary: "#C2957D", road_residential: "#DEB99F", road_default: "#DEB99F", route: "#F36A2E"
	},
	ancient_woodland: {
