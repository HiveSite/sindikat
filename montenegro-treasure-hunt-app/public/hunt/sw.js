const BASE='/hunt';
const CACHE='podgorica-hunt-v32-ux-audit';
const ASSETS=[`${BASE}/`,`${BASE}/styles-v31.css?v=32`,`${BASE}/ux-v32.css?v=32`,`${BASE}/hunt-data-v32-global.js?v=32`,`${BASE}/app-v32-1.js?v=32`,`${BASE}/app-v32-2.js?v=32`,`${BASE}/app-v32-3.js?v=32`,`${BASE}/manifest.webmanifest`,`${BASE}/assets/icon.svg`];
