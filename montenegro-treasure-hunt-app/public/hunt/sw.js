const BASE='/hunt';
const CACHE='mth-hunt-v7';
const ASSETS=[`${BASE}/`,`${BASE}/styles.css`,`${BASE}/hotfix.css?v=6`,`${BASE}/app.js`,`${BASE}/hotfix.js?v=7`,`${BASE}/manifest.webmanifest`,`${BASE}/assets/icon.svg`];
