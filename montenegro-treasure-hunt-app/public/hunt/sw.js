const BASE='/hunt';
const CACHE='mth-hunt-v11-responsive-complete';
const ASSETS=[`${BASE}/`,`${BASE}/styles.css`,`${BASE}/hotfix.css?v=10`,`${BASE}/responsive.css?v=11`,`${BASE}/app.js`,`${BASE}/hotfix.js?v=10`,`${BASE}/manifest.webmanifest`,`${BASE}/assets/icon.svg`];
