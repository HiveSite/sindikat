...
let checkpoints = [
  {
    ...
    artifactTitle: 'Field verification 01', artifactType: 'field',
    artifactLines: ['OBSERVE THE SKYLINE', 'IDENTIFY THE VERTICAL LANDMARK', 'CONFIRM THE PLACE'],
    task: 'Which visible feature best confirms that you found the intended historic place?',
    type: 'choice', options: ['A minaret', 'A cable pylon', 'A stadium floodlight', 'A lighthouse'], answer: 0,
    retry: 'Look upward. The defining vertical feature belongs to a mosque.', points: 120
  },
  {
    id: 'time', name: 'Sahat Kula', lat: 42.43595, lng: 19.26115, radius: 45,
    chapter: 'The Timekeeper', area: 'Stara Varoš', seal: 'TIME',
    ...
    artifactTitle: 'Field verification 02', artifactType: 'field',
    artifactLines: ['STONE TOWER', 'PUBLIC TIMEKEEPER', 'VERIFY THE UPPER FEATURE'],
    task: 'What visible feature makes this structure a timekeeper rather than an ordinary tower?',
    type: 'choice', options: ['A clock face', 'A drawbridge', 'A weather vane', 'A bell-shaped roof only'], answer: 0,
    retry: 'Use the feature that directly communicates time.', points: 140
  },
  {
    id: 'record', name: 'Starodoganjska Mosque area', lat: 42.43612, lng: 19.26006, radius: 55,
    chapter: 'The Old Record', area: 'Stara Varoš', seal: 'RECORD',
    ...
    artifactTitle: 'Field verification 03', artifactType: 'record',
    artifactLines: ['DOGANA', 'TRADE / CUSTOMS', 'RECORD / ACCOUNT'],
    task: 'Complete the field keyword: DOGANA was tied to ______ and records.',
    type: 'text', answerText: 'CUSTOMS',
    retry: 'Think of goods entering a city and the paperwork checked at entry.', points: 150
  },
  {
    id: 'safe', name: 'Ribnica Fortress / Depedogen', lat: 42.43772, lng: 19.25712, radius: 60,
    chapter: 'The Safe Point', area: 'Ribnica', seal: 'KEEP',
    ...
    artifactTitle: 'Field verification 04', artifactType: 'bundle',
    artifactLines: ['STONE', 'CONTROL THE APPROACH', 'KEEP / PROTECT'],
    task: 'Which function best fits the place in front of you?',
    type: 'choice', options: ['Protection and control', 'Open-air market only', 'Railway platform', 'Modern office complex'], answer: 0,
    retry: 'Use the stone defensive remains and their position over the river approach.', points: 145
  },
  {
    id: 'waiting', name: 'Skaline', lat: 42.43915, lng: 19.25874, radius: 60,
    chapter: 'Down to the River', area: 'Ribnica riverbank', seal: 'DESCENT',
    ...
    artifactTitle: 'Field verification 05', artifactType: 'route',
    artifactLines: ['CITY LEVEL', 'STEPS / DESCENT', 'RIVER LEVEL'],
    task: 'What physical movement defines this location?',
    type: 'choice', options: ['Descending by steps toward the river', 'Climbing a cable bridge', 'Entering a tunnel', 'Crossing railway tracks'], answer: 0,
    retry: 'Pay attention to the level change between the centre and Ribnica.', points: 150
  },
  {
    id: 'ordinary', name: 'Independence Square', lat: 42.44138, lng: 19.26266, radius: 60,
    chapter: 'The Public Square', area: 'City centre', seal: 'CROWD',
    ...
    artifactTitle: 'Field verification 06', artifactType: 'field',
    artifactLines: ['OPEN SPACE', 'PUBLIC MOVEMENT', 'CITY CENTRE'],
    task: 'Which description best matches the space you are standing in?',
    type: 'choice', options: ['An open civic square', 'A fortress courtyard', 'A river gorge', 'A private garden'], answer: 0,
    retry: 'Use the scale and openness of the public space around you.', points: 120
  },
  {
    id: 'apology', name: 'Bokeška Street', lat: 42.44215, lng: 19.26086, radius: 65,
    chapter: 'The Talking Street', area: 'City centre', seal: 'VOICE',
    ...
    artifactTitle: 'Field verification 07', artifactType: 'letter',
    artifactLines: ['VOICES OUTSIDE', 'WORDS TRAVEL', 'SOME WORDS DO NOT'],
    task: 'What gives this street its strongest social character?',
    type: 'choice', options: ['Cafés and conversation', 'Cargo cranes', 'Airport gates', 'Fortress walls'], answer: 0,
    retry: 'Use what the street is known for at ground level.', points: 150
  },
  {
    id: 'memory', name: 'Njegošev Park', lat: 42.44255, lng: 19.25742, radius: 70,
    chapter: 'The Quiet Edge', area: 'Morača river edge', seal: 'PAUSE',
    ...
    artifactTitle: 'Field verification 08', artifactType: 'split',
    artifactLines: ['CITY / MOVEMENT', 'PARK / PAUSE', 'RIVER / EDGE'],
    task: 'Which transition best describes this location?',
    type: 'choice', options: ['From city centre toward a green river edge', 'From airport to runway', 'From harbour to sea', 'From tunnel to station'], answer: 0,
    retry: 'Use the park and the nearby Morača as your two reference points.', points: 155
  },
  {
    id: 'crossing', name: 'Millennium Bridge', lat: 42.44462, lng: 19.25849, radius: 80,
    chapter: 'The Crossing', area: 'Morača', seal: 'CROSS',
    ...
    artifactTitle: 'Field verification 09', artifactType: 'route',
    artifactLines: ['SIDE A', 'CABLE-STAYED SPAN', 'SIDE B'],
    task: 'Type the name of the tall structural element above the deck that anchors the cable fan.',
    type: 'text', answerText: 'PYLON',
    retry: 'It is the tall vertical structural element that the cables connect to.', points: 160
  },
  {
    id: 'date', name: 'King’s Park', lat: 42.43964, lng: 19.26483, radius: 65,
    chapter: 'The Formal Garden', area: 'City centre', seal: 'ORDER',
    ...
    artifactTitle: 'Field verification 10', artifactType: 'record',
    artifactLines: ['ORDER', 'PATHS', 'COMPARE TWO VERSIONS'],
    task: 'Which description best fits the place you reached?',
    type: 'choice', options: ['A landscaped public park', 'A defensive fort', 'A market hall', 'An industrial yard'], answer: 0,
    retry: 'Use the planned greenery and public paths around you.', points: 135
  }
];
...
let STORY_BEATS = [
  ...
  {
    act: 'ACT I · THE PROMISE', title: 'Six o’clock', source: 'Marko', artifactType: 'note',
  ...
  {
    act: 'ACT I · THE PROMISE', title: 'The missing letter', source: 'Ana', artifactType: 'envelope',
  ...
  {
    act: 'ACT II · THE BREAK', title: 'Kept, not destroyed', source: 'Marko', artifactType: 'bundle',
  ...
  {
    act: 'ACT II · THE BREAK', title: 'Still waiting', source: 'Shared record', artifactType: 'split',
  ...
  {
    act: 'ACT II · THE BREAK', title: 'The wrong conclusion', source: 'Marko', artifactType: 'letter',
  ...
  {
    act: 'ACT II · THE BREAK', title: 'No private goodbye', source: 'Ana', artifactType: 'list',
  ...
  {
    act: 'ACT III · THE CONTRADICTION', title: 'The same memory', source: 'Shared record', artifactType: 'split',
  ...
  {
    act: 'ACT III · THE CONTRADICTION', title: 'Two copies', source: 'Archive', artifactType: 'split',
  ...
  {
    act: 'ACT III · THE CONTRADICTION', title: 'Correction not delivered', source: 'Delivery record', artifactType: 'record',
